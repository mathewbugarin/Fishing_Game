   /** This driver program simulates a fishing game. The program will prompt the user 
   to play and keep playing until the user is finished. The items fished will be randomly 
   based on a 6 sided die, with the value of '1' being the best item, and the value of '6' being the
...
public class Fishing_Demo
{
   public static void main(String[] args)
   {
      ...
      while (startGame.equals(playAgain)) //will loop as long as playAgain = 'yes')
      {
         ...
         Fishing fish = new Fishing(diceSides);    //created new object from Fishing_BugarinM.class
